...
int main() {
    ...
    // Determining if an entered integer is between two other integers
   ...
   cout << "Enter an integer - the bounds are " << lower << " and " << upper << " : ";
    ...
    // Determining if an entered integer is outside two other integers
    // assuming lower < upper
    ...
    // Determining if an entered integer is exactly on the boundary
    // assuming lower < upper
    cout << "\nEnter an integer - the bounds are " << lower << " and " << upper << " : ";
    cin >> num;
  ...
  //   Determining is you need to wear a coat based on temperature and wind speed    
    bool wear_coat {false}; 
    double temperature {};
    int wind_speed {};
    
    const int wind_speed_for_coat { 25 };       // winding over this value requires a coat
